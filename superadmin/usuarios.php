            ...
            <div class="card-body">
              <div class="table-responsive text-center">
                <table class="table">
                  ...
                  <tbody>
                    <?php
                    $datos = $ObjSUADM->muestraUsuarios();
                    if(!empty($datos)){
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <button type="button" class="pass btn btn-info" data-id="<?= $row['id']; ?>" data-bs-toggle="modal" data-bs-target="#editarUserPass"><i class="fa-duotone fa-key"></i></button>
