...
<body class="user-profile">
  ...
  <div class="wrapper">
    ...
    <div class="content">
      <div class="row">
        <?php
        $row = $ObjSUADM->muestraPerfilSUADM($id);
                ...
                <form>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Rol</label>
                        <input type="text" class="form-control" name="rol" disabled="" placeholder="Rol" value="Super Administrador"></input>
  ...
  <div class="modal fade" id="ACTPHOTO">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="claseSUADMIN.php" method="POST" enctype="multipart/form-data">
            <center>
