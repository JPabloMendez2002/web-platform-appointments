        ...
        <form action="" method="POST" id="formNU">
          ...
          <div class="row">
            ...
            <div class="col-md-4 pr-1">
              <div class="form-group">
                <label>Rol *</label>
                <select type="text" class="form-control" required="" id="access" name="access">
...
<div class="modal fade" id="modalsoporte">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          <input type="hidden" id="emisor" name="emisor" value="Super Administrador (<?= $_SESSION['user'] ?>)" />
        ...
        <form id="formEditaCita">
          ...
          <div class="row">
            ...
            <div class="col-md-4 pr-1">
              <div class="form-group">
                <h4>Fecha Cita</h4>
                <input type="datetime-local" class="form-control" name="fechaEDI" id="fechaEDI">
              </div>
            </div>
          </div>
        </form>
...
<!-- Actualizar Contraseña Users-->
<div class="modal fade" id="editarUserPass">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="password" class="form-control" name="contraNewUser1" id="contraNewUser1">
                <input type="hidden" name="idPassUser" id="idPassUser">
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label>Confirmar Contreseña</label>
                <input type="password" class="form-control" name="contraNewUser2" id="contraNewUser2">
              </div>
            </div>
            <div class="col-md-12 px-1">
              <center>
                <button type="button" name="cambiarcontraUsers" id="cambiarcontraUsers" class="btn btn-success">Guardar</button>
              </center>
            </div>
          </div>
        </form>
